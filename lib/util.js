...
var messages = {
    // Search keyword is not hit anything or either serviceurl or serviceselector is misconfigured.
    parse_error: "検索キーワードがヒットしなかったか、サービスURL/サービスセレクタの設定が誤っています。"
